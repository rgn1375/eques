...
# direct methods
.method public constructor <init>(Lwf/b;Lio/reactivex/functions/Function;IILio/reactivex/internal/util/ErrorMode;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableConcatMapEagerPublisher;->source:Lwf/b;
...
.method protected subscribeActual(Lwf/c;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableConcatMapEagerPublisher;->source:Lwf/b;
    ...
    .line 17
    .line 18
    invoke-interface {v0, v7}, Lwf/b;->subscribe(Lwf/c;)V
