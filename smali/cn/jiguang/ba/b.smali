...
# direct methods
.method public static a(Landroid/content/Context;Ljava/lang/String;[BIIILjava/util/Set;)Lcn/jiguang/ba/g;
    .locals 3
    ...
    invoke-virtual {v2, p1}, Lcn/jiguang/net/HttpRequest;->setType(Ljava/lang/String;)V

    invoke-static {v2, p0, p2, p3, p5}, Lcn/jiguang/ba/b;->a(Lcn/jiguang/net/HttpRequest;Landroid/content/Context;[BII)V
    ...
    const-string/jumbo p6, "status code:"

    invoke-virtual {p5, p6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {p5, p2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string p6, " retry left:"
    ...
    invoke-static {p3, p5}, Lcn/jiguang/ay/f;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance p0, Lcn/jiguang/ba/g;

    invoke-virtual {p1}, Lcn/jiguang/net/HttpResponse;->getResponseBody()Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, p5, p1}, Lcn/jiguang/ba/g;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {p0, v1, p1}, Lcn/jiguang/ba/g;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {p0, p2, p1}, Lcn/jiguang/ba/g;-><init>(ILjava/lang/String;)V
    ...
    :goto_0
    new-instance p1, Lcn/jiguang/ba/g;
    ...
    invoke-direct {p1, v1, p0}, Lcn/jiguang/ba/g;-><init>(ILjava/lang/String;)V
...
.method public static a(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;ZII)Lcn/jiguang/ba/g;
    .locals 4
    ...
    invoke-static {p3, p2, p1, p5}, Lcn/jiguang/ba/b;->a(Lcn/jiguang/net/HttpRequest;Landroid/content/Context;[BI)V
    ...
    invoke-static {p5, v2}, Lcn/jiguang/ay/f;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p1, v2, p0}, Lcn/jiguang/ba/g;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {p1, p2, p0}, Lcn/jiguang/ba/g;-><init>(ILjava/lang/String;)V
...
.method private static a(Lcn/jiguang/net/HttpRequest;Landroid/content/Context;[BI)V
    ...
    invoke-static {v2, v3}, Lcn/jiguang/bv/u;->a(J)Ljava/lang/String;
    ...
    :cond_0
    sget-object v5, Lcn/jiguang/ba/f;->b:Ljava/lang/String;

    goto :goto_1

    :cond_1
    :goto_0
    sget-object v5, Lcn/jiguang/ba/f;->a:Ljava/lang/String;

    :goto_1
    invoke-static {p2, v2, v5, v0}, Lcn/jiguang/bv/u;->a([BLjava/lang/String;Ljava/lang/String;Z)[B
    ...
    sget-object v5, Lcn/jiguang/ba/b;->a:Lcn/jiguang/net/SSLTrustManager;
    ...
    sput-object v6, Lcn/jiguang/ba/b;->a:Lcn/jiguang/net/SSLTrustManager;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {p0, v5}, Lcn/jiguang/net/HttpRequest;->setSslTrustManager(Ljavax/net/ssl/X509TrustManager;)V
    ...
    invoke-static {p2}, Lcn/jiguang/bv/v;->b([B)Ljava/lang/String;

    move-result-object p2

    invoke-static {p1, p2, v2, v0}, Lcn/jiguang/ba/f;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcn/jiguang/ba/f;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_7
    invoke-static {v2}, Lcn/jiguang/ba/f;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method private static a(Lcn/jiguang/net/HttpRequest;Landroid/content/Context;[BII)V
    ...
    sget-object v2, Lcn/jiguang/ba/b;->a:Lcn/jiguang/net/SSLTrustManager;
    ...
    sput-object v3, Lcn/jiguang/ba/b;->a:Lcn/jiguang/net/SSLTrustManager;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {p0, v2}, Lcn/jiguang/net/HttpRequest;->setSslTrustManager(Ljavax/net/ssl/X509TrustManager;)V
    ...
    invoke-virtual {p0}, Lcn/jiguang/net/HttpRequest;->getUrl()Ljava/lang/String;
    ...
    sget-object v3, Lcn/jiguang/ba/f;->f:Ljava/lang/String;

    goto :goto_0

    :cond_2
    sget-object v3, Lcn/jiguang/ba/f;->e:Ljava/lang/String;
    ...
    invoke-static {p3}, Lcn/jiguang/ba/f;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2, p3}, Lcn/jiguang/ba/f;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
