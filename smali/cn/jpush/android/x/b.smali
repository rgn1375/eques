...
.method public static a(Lcn/jpush/android/d/d;)I
    ...
    invoke-static {p0, v0}, Lcn/jpush/android/x/b;->a(Ljava/lang/String;I)I
...
.method private static a(Landroid/content/Context;Lcn/jpush/android/d/d;Lcn/jpush/android/x/c;Lcn/jpush/android/x/c;)Landroid/app/Notification;
    .locals 8

    .line 5
    new-instance v7, Lcn/jpush/android/x/a$a;

    iget-object v1, p1, Lcn/jpush/android/d/d;->H:Ljava/lang/String;

    const-string v2, ""

    iget v3, p1, Lcn/jpush/android/d/d;->C:I

    iget v4, p1, Lcn/jpush/android/d/d;->G:I

    iget-object v5, p1, Lcn/jpush/android/d/d;->at:Ljava/lang/String;

    iget v6, p1, Lcn/jpush/android/d/d;->D:I

    move-object v0, v7

    invoke-direct/range {v0 .. v6}, Lcn/jpush/android/x/a$a;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;IILjava/lang/String;I)V

    invoke-static {p0, v7}, Lcn/jpush/android/x/a;->a(Landroid/content/Context;Lcn/jpush/android/x/a$a;)V
    ...
    iget-object v2, p1, Lcn/jpush/android/d/d;->x:Ljava/lang/String;
    ...
    invoke-static {v1, v0, p2, p3}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;Landroid/app/Notification$Builder;Lcn/jpush/android/x/c;Lcn/jpush/android/x/c;)Z

    const/4 p2, 0x1

    invoke-virtual {v0, p2}, Landroid/app/Notification$Builder;->setShowWhen(Z)Landroid/app/Notification$Builder;

    invoke-static {p0, v0, v7}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;Landroid/app/Notification$Builder;Lcn/jpush/android/x/a$a;)V

    iget-object p3, v7, Lcn/jpush/android/x/a$a;->a:Ljava/lang/String;

    invoke-static {p0, p3}, Lcn/jpush/android/x/b;->d(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p3, v1, v2, p0}, Lcn/jpush/android/helper/c;->a(Ljava/lang/String;JLandroid/content/Context;)V

    :cond_0
    iget p0, p1, Lcn/jpush/android/d/d;->y:I
    ...
    iget-object p0, p1, Lcn/jpush/android/d/d;->B:Ljava/lang/String;
    ...
    iget-object p2, p1, Lcn/jpush/android/d/d;->A:Ljava/lang/String;
    ...
    :cond_6
    invoke-static {v0}, Lcn/jpush/android/x/b;->a(Landroid/app/Notification$Builder;)Landroid/app/Notification;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;)Landroid/content/Intent;
    ...
    :cond_0
    invoke-static {p0}, Lcn/jpush/android/ad/a;->i(Landroid/content/Context;)Z
...
.method public static a(Landroid/content/Context;Ljava/lang/String;I)Lcn/jpush/android/x/c;
    .locals 2
    .annotation build Landroid/annotation/TargetApi;
        value = 0xb
    .end annotation
    ...
    invoke-static {p0, p1, p2}, Lcn/jpush/android/x/b;->b(Landroid/content/Context;Ljava/lang/String;I)Ljava/lang/Object;

    move-result-object p0

    const-wide/16 p1, 0x3cd

    if-nez p0, :cond_0

    invoke-virtual {v0, p1, p2}, Lcn/jpush/android/x/c;->a(J)V
    ...
    invoke-virtual {v0, p1}, Lcn/jpush/android/x/c;->a(I)V

    invoke-virtual {v0, p0}, Lcn/jpush/android/x/c;->a(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p0}, Lcn/jpush/android/x/c;->a(Landroid/graphics/Bitmap;)V
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcn/jpush/android/x/c;
    .locals 6
    .annotation build Landroid/annotation/TargetApi;
        value = 0xb
    .end annotation
    ...
    new-instance p4, Lcn/jpush/android/x/c;

    invoke-direct {p4}, Lcn/jpush/android/x/c;-><init>()V
    ...
    invoke-static {p3}, Lcn/jpush/android/ad/a;->c(Ljava/lang/String;)Z
    ...
    invoke-static {v2, p3, v3}, Lcn/jpush/android/x/b;->d(Landroid/content/Context;Ljava/lang/String;I)Ljava/lang/String;
    ...
    :try_start_1
    invoke-static {v0}, Lcn/jpush/android/ad/c;->a(Ljava/lang/String;)Z
    ...
    invoke-virtual {p4, v3}, Lcn/jpush/android/x/c;->a(I)V

    invoke-virtual {p4, v2}, Lcn/jpush/android/x/c;->a(Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v0}, Lcn/jpush/android/x/b;->a(Ljava/lang/String;)Landroid/graphics/drawable/Icon;
    ...
    invoke-virtual {p4, v0}, Lcn/jpush/android/x/c;->a(I)V

    invoke-virtual {p4, v2}, Lcn/jpush/android/x/c;->a(Ljava/lang/Object;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    invoke-virtual {p4, v1}, Lcn/jpush/android/x/c;->b(I)V
    ...
    :try_start_2
    invoke-static {p0, p2, p5}, Lcn/jpush/android/ad/a;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string/jumbo p3, "targetApp \uff1a"
    ...
    const-wide/16 p2, 0x3e1

    invoke-virtual {p4, p2, p3}, Lcn/jpush/android/x/c;->a(J)V
    ...
    :cond_6
    invoke-static {p0, p2}, Lcn/jpush/android/x/b;->c(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p4, v1, v2}, Lcn/jpush/android/x/c;->a(J)V
    ...
    invoke-virtual {p4, p0}, Lcn/jpush/android/x/c;->a(Landroid/graphics/Bitmap;)V
    ...
    :cond_8
    invoke-static {p0}, Lcn/jpush/android/x/g;->a(Landroid/content/Context;)I
    ...
    invoke-virtual {p4, p0}, Lcn/jpush/android/x/c;->b(I)V
...
.method private static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v0}, Lcn/jpush/android/ad/a;->a(Ljava/lang/String;Z)Z
    ...
    invoke-static {p1}, Lcn/jpush/android/ad/a;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p2}, Lcn/jpush/android/ad/c;->c(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v3 .. v9}, Lcn/jpush/android/w/b;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;IJI)[B

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-static {p2, p0}, Lcn/jpush/android/ad/c;->a(Ljava/lang/String;[B)Z
...
.method public static a(Landroid/app/Notification;Lcn/jpush/android/x/a$a;)V
    .locals 0
...
.method public static a(Landroid/content/Context;)V
    ...
    .line 15
    :goto_0
    invoke-static {}, Lcn/jpush/android/x/f;->a()I
    ...
    invoke-static {p0, v0}, Lcn/jpush/android/x/b;->d(Landroid/content/Context;I)V
...
.method public static a(Landroid/content/Context;IILjava/lang/String;)V
    ...
    invoke-static {p0, p1, p2, p3, v0}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;IILjava/lang/String;Landroid/os/Bundle;)V
...
.method public static a(Landroid/content/Context;IILjava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-static {p0, v0}, Lcn/jpush/android/ad/a;->e(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {p0, v1}, Lcn/jpush/android/helper/a;->a(Landroid/content/Context;Landroid/content/Intent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static a(Landroid/content/Context;IZ)V
    ...
    sget-object v3, Lcn/jpush/android/x/b;->a:Ljava/lang/Boolean;
    ...
    :cond_1
    :goto_1
    sget-object v1, Lcn/jpush/android/x/b;->a:Ljava/lang/Boolean;
    ...
    sput-object p2, Lcn/jpush/android/x/b;->a:Ljava/lang/Boolean;
    ...
    sget-object v2, Lcn/jpush/android/x/b;->a:Ljava/lang/Boolean;
    ...
    invoke-virtual {p1, p0, p2}, Lcn/jpush/android/aa/a;->a(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_2
...
.method public static a(Landroid/content/Context;Landroid/app/Notification$Builder;Lcn/jpush/android/x/a$a;)V
    .locals 3
    ...
    :try_start_0
    iget-boolean v0, p2, Lcn/jpush/android/x/a$a;->i:Z
    ...
    iget-object v2, p2, Lcn/jpush/android/x/a$a;->a:Ljava/lang/String;
    ...
    iget-object v0, p2, Lcn/jpush/android/x/a$a;->a:Ljava/lang/String;

    invoke-static {p0, v0}, Lcn/jpush/android/x/b;->d(Landroid/content/Context;Ljava/lang/String;)Z

    iget-object p0, p2, Lcn/jpush/android/x/a$a;->a:Ljava/lang/String;

    invoke-virtual {p1, p0}, Landroid/app/Notification$Builder;->setChannelId(Ljava/lang/String;)Landroid/app/Notification$Builder;

    :cond_0
    iget p0, p2, Lcn/jpush/android/x/a$a;->c:I

    invoke-virtual {p1, p0}, Landroid/app/Notification$Builder;->setPriority(I)Landroid/app/Notification$Builder;

    iget p0, p2, Lcn/jpush/android/x/a$a;->f:I

    invoke-virtual {p1, p0}, Landroid/app/Notification$Builder;->setDefaults(I)Landroid/app/Notification$Builder;

    iget-object p0, p2, Lcn/jpush/android/x/a$a;->h:Landroid/net/Uri;
...
.method public static a(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    iget v0, p1, Lcn/jpush/android/d/d;->ad:I
    ...
    iget p1, p1, Lcn/jpush/android/d/d;->ad:I
    ...
    invoke-direct {v0, p0, p1}, Lcn/jpush/android/x/b$a;-><init>(Landroid/content/Context;Lcn/jpush/android/d/d;)V
...
.method public static a(Landroid/content/Context;Ljava/lang/Integer;Landroid/app/Notification;)V
    ...
    invoke-static {p0, p2, p1, v1}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;Landroid/app/Notification;II)Z
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;Landroid/content/Intent;)V
    ...
    invoke-static {p0, p1, p2, p3, v0}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;Landroid/content/Intent;Ljava/lang/String;)V

    return-void
.end method

.method public static a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;Landroid/content/Intent;Ljava/lang/String;)V
    .locals 4
    ...
    invoke-virtual {p2, p4}, Lcn/jpush/android/d/d;->a(Ljava/lang/String;)V
    ...
    const-string p4, "send broadcast pushEntry: "
    ...
    const-string p4, "cn.jpush.android.intent.NOTIFICATION_DISMISS"
    ...
    :cond_4
    iget-object v0, p3, Lcn/jpush/android/api/NotificationMessage;->appkey:Ljava/lang/String;
    ...
    iput-object v0, p3, Lcn/jpush/android/api/NotificationMessage;->appkey:Ljava/lang/String;
    ...
    invoke-virtual {v0, p0, p3}, Lcn/jpush/android/service/JPushMessageReceiver;->onNotifyMessageArrived(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;)V
    ...
    invoke-virtual {v0, p0, p3}, Lcn/jpush/android/service/JPushMessageReceiver;->onNotifyMessageDismiss(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;)V
    ...
    invoke-virtual {v0, p0, p3}, Lcn/jpush/android/service/JPushMessageReceiver;->onNotifyMessageOpened(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;)V

    goto :goto_2

    :cond_8
    const-string v0, "cn.jpush.android.intent.NOTIFICATION_UN_SHOW"
    ...
    invoke-virtual {v0, p0, p3}, Lcn/jpush/android/service/JPushMessageReceiver;->onNotifyMessageUnShow(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;)V

    goto :goto_2

    :cond_9
    const-string v0, "cn.jpush.android.intent.IN_APP_MSG_SHOW"
    ...
    invoke-virtual {v0, p0, p3}, Lcn/jpush/android/service/JPushMessageReceiver;->onInAppMessageShow(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;)V
    ...
    invoke-virtual {v0, p0, p3}, Lcn/jpush/android/service/JPushMessageReceiver;->onInAppMessageClick(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;)V

    goto :goto_2

    :cond_b
    :goto_1
    invoke-static {p0, v3}, Lcn/jpush/android/helper/a;->a(Landroid/content/Context;Landroid/content/Intent;)V
...
.method private static a()Z
    ...
    invoke-static {v3, v4}, Lcn/jpush/android/ad/a;->a(Ljava/lang/String;Ljava/lang/String;)I
...
.method private static a(Landroid/content/Context;Landroid/app/Notification$Builder;Lcn/jpush/android/x/c;Lcn/jpush/android/x/c;)Z
    .locals 8
    .annotation build Landroid/annotation/TargetApi;
        value = 0xb
    .end annotation
    ...
    .line 27
    invoke-virtual {p2}, Lcn/jpush/android/x/c;->a()I
    ...
    invoke-virtual {p2}, Lcn/jpush/android/x/c;->b()Ljava/lang/Object;
    ...
    invoke-virtual {p2}, Lcn/jpush/android/x/c;->c()Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p2}, Lcn/jpush/android/x/c;->d()I
    ...
    invoke-virtual {p3}, Lcn/jpush/android/x/c;->b()Ljava/lang/Object;
    ...
    invoke-virtual {p3}, Lcn/jpush/android/x/c;->c()Landroid/graphics/Bitmap;
...
.method public static a(Landroid/content/Context;Landroid/app/Notification;II)Z
    ...
    invoke-static {p1, p2}, Lcn/jpush/android/x/b;->a(Landroid/app/Notification;I)Z
    ...
    :cond_0
    invoke-static {}, Lcn/jpush/android/x/b;->a()Z
    ...
    :cond_1
    invoke-static {p0, p3}, Lcn/jpush/android/x/b;->g(Landroid/content/Context;I)Z
    ...
    :cond_2
    invoke-static {}, Lcn/jpush/android/ad/a;->b()Z
    ...
    :cond_3
    invoke-static {p0, p3}, Lcn/jpush/android/x/b;->f(Landroid/content/Context;I)Z
    ...
    :cond_5
    invoke-static {p0, p3}, Lcn/jpush/android/x/b;->e(Landroid/content/Context;I)Z
...
.method public static a(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    const-string v4, "handleOriginalMessage string="
    ...
    const-string v4, "handleOriginalMessage json="
    ...
    const-string v5, "handleOriginalMessage msgID="
    ...
    const-string v5, "handleOriginalMessage originalMessage="
    ...
    const-string v5, "handleOriginalMessage jsonObject="
    ...
    const-string v2, "notificaion_type"
    ...
    const-string v1, "handleOriginalMessage local notification return true"
    ...
    const-string v5, "handleOriginalMessage server ssl="
    ...
    invoke-static {p0}, Lcn/jpush/android/helper/JCoreHelper;->getUid(Landroid/content/Context;)J
    ...
    invoke-static {v4}, Lcn/jpush/android/ad/l;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v5, "handleOriginalMessage local ssl="
    ...
    const-string v1, "handleOriginalMessage check success"
    ...
    :cond_3
    const-string v1, "handleOriginalMessage check fail drop it"

    invoke-static {v0, v1}, Lcn/jpush/android/helper/Logger;->d(Ljava/lang/String;Ljava/lang/String;)V

    const-wide/16 v0, 0x453
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;Lcn/jpush/android/api/NotificationMessage;)Z
    ...
    :cond_0
    iget-object v2, p2, Lcn/jpush/android/d/d;->I:Ljava/lang/String;
    ...
    invoke-static {p0, v4, p2, v3}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;Landroid/content/Intent;)V

    iget-object p1, p2, Lcn/jpush/android/d/d;->d:Ljava/lang/String;

    const-wide/16 p2, 0x424
...
.method public static b(Landroid/content/Context;Landroid/content/Intent;)Lcn/jpush/android/d/d;
    ...
    :cond_0
    invoke-static {p0}, Lcn/jpush/android/d/d;->b(Ljava/lang/String;)Lcn/jpush/android/d/d;
...
.method public static b(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1, v0}, Lcn/jpush/android/x/b;->b(Landroid/content/Context;Ljava/lang/String;I)Ljava/lang/Object;
...
.method public static b(Landroid/content/Context;Ljava/lang/String;I)Ljava/lang/Object;
    ...
    invoke-static {p1}, Lcn/jpush/android/ad/a;->c(Ljava/lang/String;)Z
    ...
    invoke-static {v4, p1, p2}, Lcn/jpush/android/x/b;->d(Landroid/content/Context;Ljava/lang/String;I)Ljava/lang/String;
...
.method public static b(Landroid/content/Context;I)V
    ...
    .line 5
    invoke-static {p1}, Lcn/jpush/android/x/f;->b(I)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p1}, Lcn/jpush/android/x/f;->a(I)Z
    ...
    invoke-static {}, Lcn/jpush/android/x/f;->b()I
    ...
    invoke-static {p0, p1}, Lcn/jpush/android/x/b;->d(Landroid/content/Context;I)V
...
.method public static b(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    :try_start_0
    iget-object v0, v2, Lcn/jpush/android/d/d;->x:Ljava/lang/String;
    ...
    :try_start_1
    invoke-static {v1, v5, v2, v6}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;Landroid/content/Intent;)V
    ...
    invoke-static {v1, v0, v2, v7}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;Lcn/jpush/android/api/NotificationMessage;)Z
    ...
    iget-object v9, v2, Lcn/jpush/android/d/d;->J:Ljava/lang/String;
    ...
    :cond_2
    iget-object v9, v2, Lcn/jpush/android/d/d;->M:Ljava/lang/String;
    ...
    iget-object v12, v2, Lcn/jpush/android/d/d;->Q:Ljava/lang/String;

    iget-object v14, v2, Lcn/jpush/android/d/d;->d:Ljava/lang/String;

    iget-object v15, v2, Lcn/jpush/android/d/d;->N:Ljava/lang/String;

    invoke-static/range {v10 .. v15}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcn/jpush/android/x/c;

    move-result-object v9

    invoke-virtual {v9}, Lcn/jpush/android/x/c;->e()J
    ...
    invoke-static {v0, v5, v6, v1}, Lcn/jpush/android/helper/c;->a(Ljava/lang/String;JLandroid/content/Context;)V
    ...
    :cond_3
    new-instance v10, Lcn/jpush/android/x/c;

    invoke-direct {v10}, Lcn/jpush/android/x/c;-><init>()V

    iget-object v11, v2, Lcn/jpush/android/d/d;->L:Ljava/lang/String;
    ...
    invoke-static {v10, v11, v14}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;Ljava/lang/String;I)Lcn/jpush/android/x/c;

    move-result-object v10

    invoke-virtual {v10}, Lcn/jpush/android/x/c;->e()J
    ...
    invoke-static {v1, v7}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;)Lcn/jpush/android/api/PushNotificationBuilder;
    ...
    :try_start_4
    invoke-static {v1, v2, v9, v10}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;Lcn/jpush/android/d/d;Lcn/jpush/android/x/c;Lcn/jpush/android/x/c;)Landroid/app/Notification;
    ...
    :goto_3
    :try_start_5
    invoke-static/range {p1 .. p1}, Lcn/jpush/android/x/b;->a(Lcn/jpush/android/d/d;)I

    move-result v9

    iput v9, v2, Lcn/jpush/android/d/d;->e:I

    iput-object v8, v2, Lcn/jpush/android/d/d;->as:Ljava/lang/String;

    iget-boolean v8, v2, Lcn/jpush/android/d/d;->X:Z
    :try_end_5
    ...
    :try_start_6
    iget v8, v2, Lcn/jpush/android/d/d;->ac:I

    const/4 v12, 0x2

    if-ne v12, v8, :cond_8

    invoke-static {v1, v10, v2}, Lcn/jpush/android/x/b;->b(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;)Landroid/content/Intent;
    ...
    :cond_8
    invoke-static {v1, v10, v2}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;)Landroid/content/Intent;
    ...
    :cond_9
    invoke-static {v1, v10, v2}, Lcn/jpush/android/x/b;->c(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;)Landroid/content/Intent;
    ...
    invoke-static {v1, v8, v2}, Lcn/jpush/android/x/b;->c(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;)Landroid/content/Intent;
    ...
    invoke-static {v8}, Lcn/jpush/android/x/b;->a(I)I
    ...
    invoke-static/range {p0 .. p0}, Lcn/jpush/android/x/b;->c(Landroid/content/Context;)Z
    ...
    iget-object v10, v2, Lcn/jpush/android/d/d;->ai:Ljava/lang/Integer;

    invoke-static {v1, v10, v0}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;Ljava/lang/Integer;Landroid/app/Notification;)V

    invoke-virtual {v8, v9, v0}, Landroid/app/NotificationManager;->notify(ILandroid/app/Notification;)V

    invoke-static {v1, v9}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;I)Z
    ...
    :cond_d
    iget-byte v0, v2, Lcn/jpush/android/d/d;->ah:B

    if-nez v0, :cond_f

    invoke-static {v1, v9}, Lcn/jpush/android/x/b;->b(Landroid/content/Context;I)V

    invoke-static/range {p0 .. p0}, Lcn/jpush/android/x/b;->d(Landroid/content/Context;)I
    ...
    const-wide/16 v8, 0x40c

    invoke-static {v0, v8, v9, v1}, Lcn/jpush/android/helper/c;->a(Ljava/lang/String;JLandroid/content/Context;)V
    ...
    iget-byte v8, v2, Lcn/jpush/android/d/d;->ah:B
    ...
    invoke-static {v1, v5, v4, v6}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;IILjava/lang/String;)V
    ...
    invoke-static {v2, v4, v5, v1}, Lcn/jpush/android/helper/c;->a(Ljava/lang/String;JLandroid/content/Context;)V
...
.method public static declared-synchronized c(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    .line 2
    const-class v0, Lcn/jpush/android/x/b;
...
.method public static c(Landroid/content/Context;Landroid/content/Intent;)Lcn/jpush/android/api/NotificationMessage;
    ...
    .line 3
    invoke-static {p0, p1}, Lcn/jpush/android/x/b;->b(Landroid/content/Context;Landroid/content/Intent;)Lcn/jpush/android/d/d;
...
.method public static c(Landroid/content/Context;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcn/jpush/android/ad/a;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v4}, Lcn/jpush/android/ad/c;->c(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v4, "picture notification resource path: "
    ...
    invoke-static {v2, v3}, Lcn/jpush/android/helper/Logger;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string p2, "need not download again with same url:"
    ...
    :cond_1
    const-string v2, "notify_img"

    const/4 v3, 0x2

    invoke-static {p0, p1, v2, v3, p2}, Lcn/jpush/android/w/b;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;II)[B

    move-result-object p0

    if-eqz p0, :cond_2

    invoke-static {v0, p0}, Lcn/jpush/android/ad/c;->a(Ljava/lang/String;[B)Z
...
.method public static c(Landroid/content/Context;I)V
    ...
    invoke-static {p0, v1}, Lcn/jpush/android/x/b;->d(Landroid/content/Context;I)V
...
.method public static c(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    invoke-static {p1}, Lcn/jpush/android/x/b;->a(Lcn/jpush/android/d/d;)I
...
.method private static d(Landroid/content/Context;Ljava/lang/String;I)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lcn/jpush/android/x/b;->c(Landroid/content/Context;Ljava/lang/String;I)Ljava/lang/String;
...
.method static synthetic d(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    .line 4
    invoke-static {p0, p1}, Lcn/jpush/android/x/b;->g(Landroid/content/Context;Lcn/jpush/android/d/d;)V
...
.method static synthetic e(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lcn/jpush/android/x/b;->f(Landroid/content/Context;Lcn/jpush/android/d/d;)V
...
.method private static e(Landroid/content/Context;I)Z
    ...
    invoke-static {p0}, Lcn/jpush/android/x/b;->h(Landroid/content/Context;)Ljava/lang/String;
...
.method private static f(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    iget-object v7, p1, Lcn/jpush/android/d/d;->Y:Ljava/lang/String;
    ...
    :cond_1
    const-string v1, "Show url is Empty! Give up to download!"
    ...
    :goto_0
    invoke-static {p0, v0}, Lcn/jpush/android/ad/c;->c(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    const-wide/16 v3, 0x3f6
    ...
    iget-object v6, p1, Lcn/jpush/android/d/d;->ae:Ljava/util/ArrayList;
    ...
    invoke-static {v6, p0, v5, v0, v8}, Lcn/jpush/android/x/h;->a(Ljava/util/ArrayList;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v0, v3, v4, p0}, Lcn/jpush/android/helper/c;->a(Ljava/lang/String;JLandroid/content/Context;)V
    ...
    :cond_2
    const-string v6, "Loads rich push resources succeed, webView will open cache!"

    invoke-static {v9, v6}, Lcn/jpush/android/helper/Logger;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v5, v2}, Ljava/lang/String;->replaceAll(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-static {v1, v2}, Lcn/jpush/android/ad/c;->b(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iput-object v1, p1, Lcn/jpush/android/d/d;->aa:Ljava/lang/String;
    ...
    iput-object v0, p1, Lcn/jpush/android/d/d;->aa:Ljava/lang/String;
    ...
    invoke-static {v9, p1}, Lcn/jpush/android/helper/Logger;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, v2, p1, p0}, Lcn/jpush/android/helper/c;->a(Ljava/lang/String;JLjava/lang/String;Landroid/content/Context;)V
...
.method private static g(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    .line 2
    iget-object v0, p1, Lcn/jpush/android/d/d;->A:Ljava/lang/String;

    const-string v1, ""

    iput-object v1, p1, Lcn/jpush/android/d/d;->A:Ljava/lang/String;

    iget v1, p1, Lcn/jpush/android/d/d;->y:I
    ...
    :cond_0
    invoke-static {p0, v0}, Lcn/jpush/android/ad/c;->e(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    iput-object p0, p1, Lcn/jpush/android/d/d;->A:Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1}, Lcn/jpush/android/x/b;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private static h(Landroid/content/Context;)Ljava/lang/String;
    ...
    :catchall_0
    :cond_0
    invoke-static {p0}, Lcn/jpush/android/x/b;->g(Landroid/content/Context;)Ljava/lang/String;
