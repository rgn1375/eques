...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 8
    iput-object p1, p0, Lz/k;->a:Landroid/content/Context;
...
.method private d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    .line 12
    .line 13
    iget-object p1, p0, Lz/k;->a:Landroid/content/Context;
    ...
    .line 25
    iget-object v1, p0, Lz/k;->a:Landroid/content/Context;
...
.method private g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 11
    .line 12
    invoke-direct {p0, p1, p2}, Lz/k;->f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 23
    .line 24
    invoke-direct {p0, p2}, Lz/k;->e(Landroid/net/Uri;)I
...
.method public bridge synthetic a(Ljava/lang/Object;IILr/d;)Lcom/bumptech/glide/load/engine/s;
    ...
    .line 2
    .line 3
    invoke-virtual {p0, p1, p2, p3, p4}, Lz/k;->c(Landroid/net/Uri;IILr/d;)Lcom/bumptech/glide/load/engine/s;
...
.method public bridge synthetic b(Ljava/lang/Object;Lr/d;)Z
    ...
    .line 2
    .line 3
    invoke-virtual {p0, p1, p2}, Lz/k;->h(Landroid/net/Uri;Lr/d;)Z
...
.method public c(Landroid/net/Uri;IILr/d;)Lcom/bumptech/glide/load/engine/s;
    .locals 1
    ...
    .line 10
    .line 11
    invoke-direct {p0, p1, p2}, Lz/k;->d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    .line 15
    invoke-direct {p0, p3, p1}, Lz/k;->g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 48
    .line 49
    iget-object p2, p0, Lz/k;->a:Landroid/content/Context;

    .line 50
    .line 51
    invoke-static {p2, p3, p1}, Lz/h;->b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 56
    :cond_1
    iget-object p3, p0, Lz/k;->a:Landroid/content/Context;

    .line 57
    .line 58
    invoke-static {p3, p1, p2}, Lz/h;->a(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    .line 62
    :goto_1
    invoke-static {p1}, Lz/j;->c(Landroid/graphics/drawable/Drawable;)Lcom/bumptech/glide/load/engine/s;
...
.method public h(Landroid/net/Uri;Lr/d;)Z
    .locals 0
    .param p1    # Landroid/net/Uri;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
