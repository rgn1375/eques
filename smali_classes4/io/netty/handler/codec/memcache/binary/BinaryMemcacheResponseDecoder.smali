...
.method protected buildInvalidMessage()Lio/netty/handler/codec/memcache/binary/BinaryMemcacheResponse;
    ...
    invoke-direct {v0, v1, v2}, Lio/netty/handler/codec/memcache/binary/DefaultBinaryMemcacheResponse;-><init>(Ljava/lang/String;Lio/netty/buffer/ByteBuf;)V
...
.method protected decodeHeader(Lio/netty/buffer/ByteBuf;)Lio/netty/handler/codec/memcache/binary/BinaryMemcacheResponse;
    ...
    invoke-interface {v0, v1}, Lio/netty/handler/codec/memcache/binary/BinaryMemcacheMessage;->setMagic(B)Lio/netty/handler/codec/memcache/binary/BinaryMemcacheMessage;
    ...
    invoke-interface {v0, v1}, Lio/netty/handler/codec/memcache/binary/BinaryMemcacheMessage;->setOpcode(B)Lio/netty/handler/codec/memcache/binary/BinaryMemcacheMessage;
    ...
    invoke-interface {v0, v1}, Lio/netty/handler/codec/memcache/binary/BinaryMemcacheMessage;->setKeyLength(S)Lio/netty/handler/codec/memcache/binary/BinaryMemcacheMessage;
    ...
    invoke-interface {v0, v1}, Lio/netty/handler/codec/memcache/binary/BinaryMemcacheMessage;->setExtrasLength(B)Lio/netty/handler/codec/memcache/binary/BinaryMemcacheMessage;
    ...
    invoke-interface {v0, v1}, Lio/netty/handler/codec/memcache/binary/BinaryMemcacheMessage;->setDataType(B)Lio/netty/handler/codec/memcache/binary/BinaryMemcacheMessage;
    ...
    invoke-interface {v0, v1}, Lio/netty/handler/codec/memcache/binary/BinaryMemcacheResponse;->setStatus(S)Lio/netty/handler/codec/memcache/binary/BinaryMemcacheResponse;
    ...
    invoke-interface {v0, v1}, Lio/netty/handler/codec/memcache/binary/BinaryMemcacheMessage;->setTotalBodyLength(I)Lio/netty/handler/codec/memcache/binary/BinaryMemcacheMessage;
    ...
    invoke-interface {v0, v1}, Lio/netty/handler/codec/memcache/binary/BinaryMemcacheMessage;->setOpaque(I)Lio/netty/handler/codec/memcache/binary/BinaryMemcacheMessage;
