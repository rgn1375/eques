...
# instance fields
.field private final invoker:Lio/netty/channel/ChannelHandlerInvoker;
...
.method protected constructor <init>(Lio/netty/channel/EventLoopGroup;Ljava/util/concurrent/Executor;Z)V
    ...
    .line 3
    .line 4
    new-instance p1, Lio/netty/channel/DefaultChannelHandlerInvoker;

    .line 5
    .line 6
    invoke-direct {p1, p0}, Lio/netty/channel/DefaultChannelHandlerInvoker;-><init>(Lio/netty/util/concurrent/EventExecutor;)V

    .line 7
    .line 8
    .line 9
    iput-object p1, p0, Lio/netty/channel/SingleThreadEventLoop;->invoker:Lio/netty/channel/ChannelHandlerInvoker;
...
.method public asInvoker()Lio/netty/channel/ChannelHandlerInvoker;
    ...
    .line 1
    iget-object v0, p0, Lio/netty/channel/SingleThreadEventLoop;->invoker:Lio/netty/channel/ChannelHandlerInvoker;
...
.method public bridge synthetic unwrap()Lio/netty/util/concurrent/EventExecutor;
    ...
    .line 2
    invoke-virtual {p0}, Lio/netty/channel/SingleThreadEventLoop;->unwrap()Lio/netty/channel/EventLoop;
