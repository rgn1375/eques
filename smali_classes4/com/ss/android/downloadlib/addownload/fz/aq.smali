.class public Lcom/ss/android/downloadlib/addownload/fz/aq;
...
.method public static aq()Lcom/ss/android/downloadlib/addownload/aq/fz;
    ...
    .line 1
    sget-object v0, Lcom/ss/android/downloadlib/addownload/fz/aq;->aq:Lcom/ss/android/downloadlib/addownload/aq/fz;
...
.method static synthetic aq(Lcom/ss/android/downloadlib/addownload/aq/fz;)Lcom/ss/android/downloadlib/addownload/aq/fz;
    ...
    .line 2
    sput-object p0, Lcom/ss/android/downloadlib/addownload/fz/aq;->aq:Lcom/ss/android/downloadlib/addownload/aq/fz;
...
.method public aq(Lcom/ss/android/downloadad/api/aq/hh;ILcom/ss/android/downloadlib/addownload/fz/hf;)Z
    ...
    .line 3
    :cond_0
    invoke-virtual {p1}, Lcom/ss/android/downloadad/api/aq/hh;->qy()Z
    ...
    .line 4
    :cond_1
    invoke-direct {p0, p1}, Lcom/ss/android/downloadlib/addownload/fz/aq;->aq(Lcom/ss/android/downloadad/api/aq/aq;)Z
    ...
    invoke-static {v2, v3, v4, v5, v6}, Lcom/ss/android/downloadlib/addownload/te;->aq(IJJ)J
    ...
    invoke-direct {p0, v0}, Lcom/ss/android/downloadlib/addownload/fz/aq;->aq(I)I
    ...
    .line 11
    new-instance p2, Lcom/ss/android/downloadlib/addownload/fz/aq$1;

    invoke-direct {p2, p0, p1, p3}, Lcom/ss/android/downloadlib/addownload/fz/aq$1;-><init>(Lcom/ss/android/downloadlib/addownload/fz/aq;Lcom/ss/android/downloadad/api/aq/hh;Lcom/ss/android/downloadlib/addownload/fz/hf;)V

    sput-object p2, Lcom/ss/android/downloadlib/addownload/fz/aq;->aq:Lcom/ss/android/downloadlib/addownload/aq/fz;

    sub-long/2addr v4, v2

    .line 12
    invoke-static {v4, v5}, Lcom/ss/android/downloadlib/k/l;->aq(J)Ljava/lang/String;
    ...
    .line 14
    invoke-static {p1, p2, p3, v0}, Lcom/ss/android/downloadlib/activity/TTDelegateActivity;->aq(Lcom/ss/android/downloadad/api/aq/aq;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    .line 15
    invoke-virtual {p1, v1}, Lcom/ss/android/downloadad/api/aq/hh;->e(Z)V
